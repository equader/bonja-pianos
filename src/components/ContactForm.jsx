...
function ContactForm() {
    ...
    const validateForm = () => {
        ...
        const oneServiceSelected = Object.values(formData.services).some(
            (value) => value
        );
    ...
    const getValidationClass = (name) => {
        return `form-control ${
            submitted && !formData[name] ? "is-invalid" : ""
        }`;
    };
    ...
    return (
        <div id="contact-section" className="contactPanel">
            <h1>Get in touch</h1>
            <p>
                Interested in seeing how we can help? Get in touch by calling us
                on +61 450 284 115, emailing us at mark@bonjapianos.com.au or by
                putting your contact details below and we'll be sure to get back
            ...
            >
                ...
                <div className={`row mb-3 ${getCheckboxValidationClass()}`}>
                    ...
                    {["Tuning", "Servicing", "Cleaning", "Other"].map(
                        (service) => (
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="button-container">
                            ...
                            >
                                {isSubmitted
                                    ? "Form sent. We'll get back to you in 1 - 2 days"
                                    : "Submit inquiry"}
                            </button>
                        </div>
                    </div>
