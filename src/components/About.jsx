...
function About(){
    return(
        <div id="about-section" className="about">
            <h1>About Us</h1>
                    <p>Hi! Welcome, my name's Mark Bonja, piano aficionado and founder of Bonja Pianos. I started Bonja Pianos with the firm belief in the power of music to celebrate life's moments and navigate its challenges. My expertise isn't just in tuning, cleaning and fixing pianos; it's about infusing each instrument with care and resilience and fostering a community through music.</p>
